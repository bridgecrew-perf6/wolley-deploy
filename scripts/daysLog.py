...
# 로컬환경에서 : python manage.py runscript -v2 daysLog --script-args F1 2022-02-16 2022-02-18
# 배포환경에서 : python manage.py runscript --settings=myapi.settings.deploy -v2 daysLog --script-args F1 2022-02-16 2022-02-18
